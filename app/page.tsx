                ...
                <>
                  ...
                  <form onSubmit={async (e) => {
                    ...
                    <button type="submit" disabled={sending}
                      className="w-full bg-[#3B9EFF] text-black font-bold py-3.5 rounded-xl hover:bg-[#60C5FF] transition-all hover:scale-[1.02] shadow-lg shadow-[#3B9EFF]/20 disabled:opacity-60 disabled:cursor-not-allowed">
                      {sending ? (lang === "es" ? "Enviando..." : "Sending...") : t.fSubmit}
                    </button>
                  </form>
                </>
              ) : (
